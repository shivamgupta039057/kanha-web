...
const TableBooking = ({ tablebookingData, isLoading }) => {
  ...
  const hasApiData = tablebookingData && tablebookingData.length > 0;
  const tabs = hasApiData
    ? tablebookingData?.map((tab, idx) => ({
        id: tab._id,
        title: tab.title,
        img:
  ...
  return (
    ...
    <div className="roomsuite-container">
      ...
      <div className="roomsuite-page-header">
        <h1 className="roomsuite-page-title">Table Booking</h1>
              ...
              <div className="roomsuite-room-card" key={item._id || idx}>
                ...
                <div className="roomsuite-room-content">
                  <div className="roomsuite-room-header">
                    <div>
                      <h2 className="roomsuite-room-title">{`Table ${item.tableNumber}` || "Room"}</h2>
                  ...
                  <div className="roomsuite-room-actions">
                    <Link href={`/tableBooing/${item?._id}`} className="roomsuite-btn roomsuite-btn-primary">
                      Book Now
                    </Link>
                    <Link href={`/tableBooing/${item?._id}`} className="roomsuite-btn roomsuite-btn-secondary">
                      View Details
                    </Link>
                  </div>
                </div>
